...
export const verticalMenuItems = [ 
    ...
    new Menu (2, 'Match', '/pages/dashboard', null, 'laptop', null, true, 0),
    new Menu (3, 'Listes des équipes', '/pages/match/liste-equipes', null, null, null, false, 2),
    new Menu (4, 'Listes des matchs', '/pages/match/liste-matchs', null, null, null, false, 2),
    new Menu (5, 'Listes des prochains matchs', '/pages/match/prochains', null, null, null, false, 2),
]
