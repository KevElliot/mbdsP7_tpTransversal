...
<html>
    ...
    <body>
        ...
        <div id="show-equipe" class="content scaffold-show" role="main">
            ...
            <f:display bean="equipe" />
            <g:form resource="${this.equipe}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.equipe}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
